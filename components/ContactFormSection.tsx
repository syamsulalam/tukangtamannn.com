...
export default function ContactFormSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      openWhatsAppInNewTab(link);
      setIsSuccess(true);
      setToastMessage({
        text: "WhatsApp terbuka di tab baru. Tekan tombol kirim untuk menyelesaikan konsultasi.",
        type: "success"
      });
      setFormState({ name: "", phone: "", service: "", message: "" });
      setTouched({});
      ...
      setToastMessage({
        text: "Browser memblokir popup. Mohon izinkan popup untuk situs ini, lalu coba lagi.",
        type: "error"
      });
    } finally {
      setIsSubmitting(false);
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 relative z-10">
        <div>
          ...
          <p className="text-white/70 font-medium leading-relaxed mb-12 max-w-md">
            Punya ide taman impian? Atau butuh bantuan merawat lanskap yang ada? Isi formulir di samping, klik kirim, dan WhatsApp akan langsung terbuka dengan pesan Anda yang sudah diformat lengkap.
          </p>
          ...
          <AnimatePresence mode="wait">
            {isSuccess ? (
              ...
              >
                ...
                <h3 className="text-2xl font-extrabold text-forest mb-2 tracking-tight">WhatsApp Terbuka!</h3>
                <p className="text-charcoal/70 font-medium mb-8 max-w-sm">Tab baru sudah terbuka dengan pesan terformat lengkap. Cukup tekan tombol kirim di WhatsApp untuk menghubungi tim TukangTamannn.com.</p>
              ...
              >
                ...
                <p className="text-[10px] text-charcoal/50 text-center font-medium leading-relaxed">
                  Klik tombol di atas untuk langsung membuka WhatsApp dengan pesan Anda yang sudah diformat lengkap.
                </p>
              </motion.form>
            )}
          </AnimatePresence>
